...
namespace CLOAPISample
{
	...
	bool APIStorage::GetFilePathWithID(const QString& itemId, QString& resultFilePath)
	{
		...
		{
			resultFilePath = QString::fromStdString(DirectoryUtil::getSampleStorageDirectory()) + curItem.metaData[META_DATA_KEY_0_DATA_TYPE].toString().toLower() + "/" + curItem.sampleItemData.itemPath;
			return true;
		}
	...
	bool APIStorage::GetIconThumbnailPathWithID(const QString& itemId, QString& resultFilePath)
	{
		...
		if (GetItemWithID(itemId, curItem))
		{
			if(curItem.sampleItemData.iconThumbnailPath != "")
				resultFilePath = QString::fromStdString(DirectoryUtil::getSampleStorageDirectory()) + curItem.metaData[META_DATA_KEY_0_DATA_TYPE].toString().toLower() + "/" + curItem.sampleItemData.iconThumbnailPath;
			else
				resultFilePath = QString::fromStdString(DirectoryUtil::getSampleStorageDirectory()) + curItem.metaData[META_DATA_KEY_0_DATA_TYPE].toString().toLower() + "/" + curItem.sampleItemData.itemPath;
	...
	bool APIStorage::GetPreviewThumbnailPathWithID(const QString& itemId, QString& resultFilePath)
	{
		...
		if (GetItemWithID(itemId, curItem))
		{
			if (curItem.sampleItemData.previewThumbnailPath != "")
				resultFilePath = QString::fromStdString(DirectoryUtil::getSampleStorageDirectory()) + curItem.metaData[META_DATA_KEY_0_DATA_TYPE].toString().toLower() + "/" + curItem.sampleItemData.previewThumbnailPath;
			else
				resultFilePath = QString::fromStdString(DirectoryUtil::getSampleStorageDirectory()) + curItem.metaData[META_DATA_KEY_0_DATA_TYPE].toString().toLower() + "/" + curItem.sampleItemData.itemPath;
...
//		fabricItem1->dateTime = "2019-01-20T11:11:21";
		...
		fabricItem1->sampleItemData.itemPath = "fabric1.jpg";
		fabricItem1->sampleItemData.iconThumbnailPath = "fabric1.jpg";
		fabricItem1->sampleItemData.previewThumbnailPath = "fabric1.jpg";
		...
		fabricItem2->sampleItemData.itemPath = "fabric2.jpg";
		fabricItem2->sampleItemData.iconThumbnailPath = "fabric2.jpg";
		fabricItem2->sampleItemData.previewThumbnailPath = "fabric2.jpg";
		...
		fabricItem3->sampleItemData.itemPath = "fabric3.png";
		fabricItem3->sampleItemData.iconThumbnailPath = "fabric3.png";
		fabricItem3->sampleItemData.previewThumbnailPath = "fabric3.png";
		...
		fabricItem4->sampleItemData.itemPath = "Cotton_14_Wale_Corduroy.zfab";
		fabricItem4->sampleItemData.iconThumbnailPath = "Cotton_14_Wale_Corduroy.zfab";    // thumbnail inside zfab
		fabricItem4->sampleItemData.previewThumbnailPath = "Cotton_14_Wale_Corduroy.zfab"; // thumbnail inside zfab
	...
	void APIStorage::generateAPIItemListForProjectFiles()
	{
		...
		projectItem1->sampleItemData.itemPath = "sample_zprj.zprj";
		projectItem1->sampleItemData.iconThumbnailPath = "sample_zprj.png";
		projectItem1->sampleItemData.previewThumbnailPath = "sample_zprj.zprj"; // thumbnail inside zprj
